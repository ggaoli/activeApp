...
(function(root, factory) {
    ...
    function(window, define, require) {
        ...
        define("dollar", ["dollar-third"],
            function(_) {
                return _
            });
        define("promise-third", ["dollar"],
            function($) {
                return {
                    Deferred: $.Deferred,
                    when: $.when,
        ...
        define("promise", ["promise-third"],
            function(_) {
                return _
            });
        define("base", ["dollar", "promise"],
            function($, promise) {
                var noop = function() {},
                    call = Function.call;
        ...
        define("runtime/runtime", ["base", "mediator"],
            function(Base, Mediator) {
                var $ = Base.$,
                    factories = {},
        ...
        define("runtime/client", ["base", "mediator", "runtime/runtime"],
        ...
        define("lib/dnd", ["base", "mediator", "runtime/client"],
            function(Base, Mediator, RuntimeClent) {
                var $ = Base.$;
                function DragAndDrop(opts) {
                    opts = this.options = $.extend({},
                        DragAndDrop.options, opts);
        ...
        define("widgets/widget", ["base", "uploader"],
            function(Base, Uploader) {
                ...
                $.extend(Uploader.prototype, {
                    _init: function() {
                        ...
                        $.each(widgetClass,
                            function(_, klass) { (!deactives || !~deactives.indexOf(klass._name)) && widgets.push(new klass(me))
                            });
        ...
        define("lib/filepaste", ["base", "mediator", "runtime/client"],
            function(Base, Mediator, RuntimeClent) {
                var $ = Base.$;
        ...
        define("widgets/filepaste", ["base", "uploader", "lib/filepaste", "widgets/widget"],
        ...
        define("widgets/filepicker", ["base", "uploader", "lib/filepicker", "widgets/widget"],
        ...
        define("lib/image", ["base", "runtime/client", "lib/blob"],
        ...
        define("widgets/queue", ["base", "uploader", "queue", "file", "lib/file", "runtime/client", "widgets/widget"],
        ...
        define("lib/transport", ["base", "runtime/client", "mediator"],
            function(Base, RuntimeClient, Mediator) {
                var $ = Base.$;
                function Transport(opts) {
                    var me = this;
                    opts = me.options = $.extend(true, {},
        ...
        define("widgets/upload", ["base", "uploader", "file", "lib/transport", "widgets/widget"],
            function(Base, Uploader, WUFile, Transport) {
                ...
                Uploader.register({
                    ...
                    startUpload: function(file) {
                        ...
                        file || $.each(me.request("get-files", Status.INTERRUPT),
                            function() {
                                this.setStatus(Status.PROGRESS)
                            });
                        me._trigged = false;
                    ...
                    _tick: function() {
                        ...
                        if (me.pool.length < opts.threads && (val = me._nextBlock())) {
                            ...
                            if (!me.remaning && !me._getStats().numOfQueue && !me._getStats().numofInterrupt) {
                                me.runing = false;
                    ...
                    _getStack: function() {
                        ...
                        while ((act = this.stack[i++])) {
                            if (act.has() && act.file.getStatus() === Status.PROGRESS) {
                                ...
                                if (!act.has() || act.file.getStatus() !== Status.PROGRESS && act.file.getStatus() !== Status.INTERRUPT) {
                    ...
                    _prepareNextFile: function() {
                        ...
                        if (file) {
                            ...
                            promise.done(function() {
                                var idx = $.inArray(promise, pending);~idx && pending.splice(idx, 1, file)
                            });
                    ...
                    _finishFile: function(file, ret, hds) {
                        var owner = this.owner;
                        return owner.request("after-send-file", arguments,
                            function() {
        ...
        define("lib/md5", ["runtime/client", "mediator"],
        ...
        define("widgets/md5", ["base", "uploader", "lib/md5", "lib/blob", "widgets/widget"],
        ...
        define("runtime/html5/runtime", ["base", "runtime/runtime", "runtime/compbase"],
            ...
            function(Base, Html5Runtime, File) {
                ...
                return Html5Runtime.register("DragAndDrop", {
                    ...
                    _dropHandler: function(e) {
                        ...
                        me._getTansferFiles(dataTransfer,
                            function(results) {
                                me.trigger("drop", $.map(results,
                                    function(file) {
        ...
        define("runtime/html5/util", ["base"],
            function(Base) {
        ...
        define("runtime/html5/imagemeta", ["runtime/html5/util"],
            function(Util) {
                var api;
                api = {
                    parsers: {
        ...
        define("runtime/html5/androidpatch", ["runtime/html5/util", "runtime/html5/jpegencoder", "base"],
        ...
        define("runtime/html5/image", ["base", "runtime/html5/runtime", "runtime/html5/util"],
        ...
        define("runtime/flash/runtime", ["base", "runtime/runtime", "runtime/compbase"],
            function(Base, Runtime, CompBase) {
                var $ = Base.$,
                    type = "flash",
                    components = {};
        ...
        define("runtime/flash/image", ["runtime/flash/runtime"],
            function(FlashRuntime) {
        ...
        define("runtime/flash/transport", ["base", "runtime/flash/runtime", "runtime/client"],
        ...
        define("runtime/flash/blob", ["runtime/flash/runtime", "lib/blob"],
        ...
        define("widgets/log", ["base", "uploader", "widgets/widget"],
            function(Base, Uploader) {
                var $ = Base.$,
        ...
        define("webuploader", ["preset/all", "widgets/log"],
            function(preset) {
                return preset
            });
